...
function theme_scripts_styles()
{
	...
	wp_enqueue_style('bootstrap', '//stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css', [], '4.5.2');
	wp_enqueue_style('theme-css', get_template_directory_uri() . '/assets/css/style.css', [], '1.0');

	wp_deregister_script('jquery');
	wp_enqueue_script('jquery', '//code.jquery.com/jquery-3.1.0.js', [], '3.1.0', false);
	wp_enqueue_script('bootstrap', '//stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js', ['jquery'], '4.5.2', true);
	wp_enqueue_script('theme-js', get_template_directory_uri() . '/assets/js/script.js', ['jquery'], '1.0', true);
}
